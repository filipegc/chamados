...
-- Backup do banco de dados 'sistema_chamados' (Apenas Estrutura)
-- Gerado em: 2025-07-20 16:25:41
...
CREATE TABLE `chamados` (
  ...
  CONSTRAINT `fk_chamados_categoria` FOREIGN KEY (`categoria_id`) REFERENCES `categorias_chamado` (`id`) ON DELETE SET NULL,
...
CREATE TABLE `imagens_embutidas` (
  `id` int NOT NULL AUTO_INCREMENT,
  `mensagem_id` int NOT NULL,
  ...
  CONSTRAINT `fk_imagens_embutidas_mensagem` FOREIGN KEY (`mensagem_id`) REFERENCES `mensagens` (`id`) ON DELETE CASCADE
